...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-800 text-white w-full py-4 relative z-20 px-4">
      ...
      <div className="flex md:hidden flex-col items-center space-y-2 w-full">
        {/* Kontakt och copyright-text centrerade med 1/3 mellanrum */}
        <div className="flex justify-between items-center w-full px-4">
          <a
            href="https://www.instagram.com/tracksterapp/profilecard/?igsh=dHIzOXB6Nzk3c2Uw"
            className="hover:text-gray-300 transition duration-300 flex items-center justify-center w-1/3"
          >
            Contact Us
            <svg
              className="w-5 h-5 ml-2"
          ...
          <p className="text-sm text-center w-1/3">
            © 2024 Trackster App. All rights reserved.
          </p>
        </div>
      </div>
